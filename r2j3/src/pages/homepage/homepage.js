            ...
            <Container fluid>
                <Row style={{height: '100vh'}}>
                    <Col md={2} style={{backgroundColor: '#2C303A'}} className="custom_sidebar">
                        ...
                        <Col className="column_right"><p class="folderTxt">NEW FOLDER</p><i className="fas fa-folder-plus folderIs"></i></Col>
                        </Row>
                        ...
                        {this.state.objects.length ? (
                            ...
                            <hr></hr>
                            <Row>
                                <Col className="column_right"><p className="upload" onClick={() => this.setShow()}>UPLOAD</p><i class="fas fa-plus-circle upCircle" onClick={() => this.setShow()}></i></Col>
                            </Row>
                            <Modal show={this.state.setShow} onHide={() => this.handleClose()}>
                                <Modal.Header className="uploadModal" closeButton>
                                    <Modal.Title>Import to Yuuvis</Modal.Title>
                                </Modal.Header>
                                <Modal.Body className="uploadModal">
                                    <Row>
                                        <Col md={3}>
                                            <p className="urlHeading">URL:</p>
                                        </Col>
                                        <Col>
                                    ...
                                    <Modal.Footer className="uploadModal">
                                    <Button variant="secondary" onClick={() => this.handleClose()}>
                                        Close
                                    </Button>
                                    <Button variant="primary" className="yuButton" onClick={() => this.handleClose()}>
                                        Upload
                                    </Button>
                                </Modal.Footer>
                            </Modal>
